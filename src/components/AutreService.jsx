    ...
    return (
        <section className="bg-[#002057]">
          <div className="lg:flex flex-col py-[100px] mx-auto px-[.75rem] sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1140px] 2xl:max-w-[1320px] 3xl:max-w-[1620px]"> 
           <Boules/>   
           <h2 className="font-bold text-[25px] lg:text-[32px] text-[#E0E0E0] text-center py-10">{AUTRESERVICE.h2}</h2>   
      
           <div className="mx-auto cursor-pointer max-w-sm px-4 md:px-0  pt-10 grid md:grid-cols-2 md:max-w-fit lg:grid-cols-3 md:gap-5 lg:gap-10 justify-center">
           {
            AUTRESERVICE.services.map((items)=>
            <NavLink className="mt-6 md:mt-0 " key={items.id} to={items.link.link}>
              <div  className="relative hover:bottom-3 bg-[#f0f8ff] text-slate-800 mx-auto flex flex-col items-center justify-center px-10 lg:px-5 pb-8 pt-8  rounded-2xl w-fit  max-w-sm ">
