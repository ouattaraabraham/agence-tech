...
const Contacter = () => {
    return (
        <section className="bg-[#01225c]">
          <div className="py-[50px] lg:py-[100px] lg:flex items-center justify-between mx-auto px-[.75rem] sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1140px] 2xl:max-w-[1320px] 3xl:max-w-[1620px]">     
