...
export default function ServiceMarketing() {
  return (
    <section className="bg-[#F9F9F9]">
        <div className="text-slate-800  py-[50px] lg:py-[100px] justify-between mx-auto px-[.75rem] sm:max-w-[540px] md:max-w-[960px] lg:max-w-[960px]] xl:max-w-[1140px] 2xl:max-w-[1320px] 3xl:max-w-[1620px]">
