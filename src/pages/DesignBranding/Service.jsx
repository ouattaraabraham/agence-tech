...
const ServiceMarketing = () => {
  return (
    <section className="bg-[#f0f8ff] text-[#172153]">
      <div className="mx-auto h-1 lg:h-2 w-[50%] rounded-lg bg-[#002057] "></div>
      <div className="py-[50px] lg:py-[100px] mx-auto px-[20px] max-w-[560px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1140px] 2xl:max-w-[1320px] 3xl:max-w-[1620px]">
        <div className="lg:flex justify-between gap-10">
          ...
          <div className="lg:w-[50%]">
            <h2 className="pb-8 font-bold text-[#FFF5CC]] text-[20px] lg:text-[25px]">{DATAMARKETING.serviceMarketing.h2}</h2>
            {
